"""
Script de inicialización simplificado del Sistema de Planillas Multirégimen Perú
"""

from app_simple import app, db, Empresa, Empleado, Locador, Configuracion
...
def mostrar_resumen():
    ...
    with app.app_context():
        ...
        print("="*60)
        print("1. Ejecutar: python app_simple.py")
