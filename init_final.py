"""
Script de inicialización simplificado - Sin errores de SQLAlchemy
"""

from app_final import app, db, Empresa, Empleado, Locador, Configuracion
...
def mostrar_resumen():
    ...
    with app.app_context():
        try:
            ...
            print("="*60)
            print("1. Ejecutar: python app_final.py")
