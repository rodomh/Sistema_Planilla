"""
Script de prueba final para verificar que el sistema funcione correctamente
"""

from app_final import app, db, Empresa, Empleado, Locador
from datetime import datetime, date

def prueba_sistema_final():
    """Prueba completa del sistema final"""
    print("="*60)
    print("PRUEBA DEL SISTEMA FINAL")
    print("="*60)
    ...
    with app.app_context():
        try:
            ...
            print(f"   OK: Cuenta bancaria: {empleado.cuenta_bancaria or 'No registrada'}")
            print(f"   OK: Banco: {empleado.banco or 'No registrado'}")
            print(f"   OK: Tipo de pago: {empleado.tipo_pago or 'mensual'}")
            ...
            if not locadores:
                print("   Creando locador de prueba...")
                locador = Locador(
                    empresa_id=empresa.id,
                    nombres='María Elena',
            ...
            print(f"   OK: Cuenta bancaria: {locador.cuenta_bancaria or 'No registrada'}")
            print(f"   OK: Banco: {locador.banco or 'No registrado'}")
            ...
            print("="*60)
            print("Puede ejecutar: python app_final.py")
...
if __name__ == '__main__':
    print("INICIANDO PRUEBA DEL SISTEMA FINAL...")
    if prueba_sistema_final():
