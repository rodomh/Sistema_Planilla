...
def prueba_sistema_funcional():
    """Prueba completa del sistema funcional"""
    print("="*60)
    print("PRUEBA DEL SISTEMA FUNCIONAL")
    print("="*60)
...
if __name__ == '__main__':
    print("INICIANDO PRUEBA DEL SISTEMA FUNCIONAL...")
    if prueba_sistema_funcional():
